...
/*
Защита от повторного подключения (копирования) файла на этапе препроцессинга
Не является частью официального стандарта языка Си, но
поддерживается популярными компиляторами.
*/
#pragma once
